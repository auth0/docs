...
Legacy applications used an [ID Token](/tokens/concepts/id-tokens) to invoke APIs. This [is a bad practice](/api-auth/why-use-access-tokens-to-secure-apis), and we recommend that you start using [Access Tokens](/tokens/concepts/access-tokens).
