...
Rules have a [global variable you can use to cache information](/rules/cache-resources). For API calls that are not user-specific, use this variable to cache the results between users. For example, getting an access token to your API.
