...
The [Delete](/connections/database/custom-db/templates/delete) script implements the function executed in order to delete the specified user identity from the legacy identity store.
...
The [Change Email](/connections/database/custom-db/templates/change-email) script implements the function executed when a change in the email address, or the email address status, for a user occurs. 
