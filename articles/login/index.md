...
Auth0 also offers the ability of embedding the login box in your own application. This approach is discouraged, as it's less secure, more difficult to implement and maintain, and prevents customers from realizing most of the current and future value of the Auth0 platform. Read our [Universal Login vs Embedded login guide](/guides/login/universal-vs-embedded) for more details. 

If you still want to implement Embedded Login, you can use one of our libraries (Such as the [Lock Widget](/libraries/lock) or [auth0.js SDK](/libraries/auth0js)) to implement login in your application, or do it via our [API](/api/authentication).
