...
description: For security reasons, rules and custom database connections for Auth0 private-saass run in a JavaScript sandbox. You can use the full power of the ECMAScript 5 language and a few selected libraries.
---

# Node.js Modules Available in Rules and Custom Database Connections

For security reasons, rules and custom database connections for Auth0 private-saass run in a JavaScript sandbox. You can use the full power of the ECMAScript 5 language and a few selected libraries.

The latest version of the private-saas supports the use of three different modes:
