...
The MFA indicator will indicate whether an Admin has enabled their account for [Mulfifactor Authentication](/multifactor-authentication), which they can do in their [Account Settings](/dashboard-account-settings#multifactor).
