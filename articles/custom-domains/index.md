...
Cloudflare has a service called CName Flattening. During the verification process, turn off the CNAME flattening process until the domain verification steps are complete.