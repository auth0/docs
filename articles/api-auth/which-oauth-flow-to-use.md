...
If this case matches your needs, then for more information on how this flow works and how to implement it, refer to [Machine-to-Machine (M2M) Flow](/flows/concepts/m2m-flow).
