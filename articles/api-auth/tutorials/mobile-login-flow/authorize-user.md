...
To authorize the user, your app must send the user to the [authorization URL](/api/authentication#authorization-code-grant-pkce-). Include the `code_challenge` you generated in the previous step and the method you used to generate the `code_challenge` (e.g., SHA-256).



## Authorize a user while adding login to your app
...
## Authorize a user while calling an API
