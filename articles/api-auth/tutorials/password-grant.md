...
- The application is absolutely trusted with the user's credentials. For [Single-Page Apps](/flows/concepts/single-page-login-flow) applications and [Native/Mobile Apps](/flows/concepts/mobile-login-flow) we recommend using web flows instead.
