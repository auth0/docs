...
Dynamic Client Registration enables you to register applications dynamically. These applications can be either [first-party or third-party applications](/applications/concepts/app-types-first-third-party).
