...
- The returned Access Token is a [JWT](/tokens/concepts/jwt), valid for calling the [/userinfo endpoint](/api/authentication#get-user-info) and the API specified by the `audience` parameter.
