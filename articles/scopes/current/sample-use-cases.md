...
::: note
Before using a custom API scope, you need to [define it for your Auth0-registered API using the Auth0 Dashboard](). You can also use defined scopes to [customize the consent dialog] for your users.
:::
