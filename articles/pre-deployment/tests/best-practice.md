...
| <dfn data-key="single-sign-on">Single Sign-on (SSO)</dfn> Timeout Values | Review the default [SSO cookie timeout values](${manage_url}/#/account/advanced) and ensure they align with your requirements. |
