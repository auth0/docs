...
| [SMS Provider](/mfa/guides/non-auth0-authenticators/configure-SMS-twilio) is configured (Dependency: MFA is configured) | Ensures that [Twilio SMS is configured](${manage_url}/#/mfa) if you're using MFA with SMS. |
