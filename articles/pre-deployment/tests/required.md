...
| [Allowed Web Origins are not Localhost](/reference/dashboard/settings-application) | Validates that the [Allowed Web Origins URLs do not point to localhost](${manage_url}/#/applications). |
