...
* Review your [Domain Settings Admin section](${manage_url}/#/tenant/admins) to make sure that only appropriate admins have access to the Auth0 dashboard.
...
* Configure your application name, support URL and support email in the [Domain Settings General](${manage_url}/#/tenant) section so when an error occurs your end users will be directed to an appropriate page.
