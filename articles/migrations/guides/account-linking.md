...
The grace period for this migration starts on **March 31, 2018** and ends on **March 31, 2019**. From that day forward you will no longer be able to use ID Tokens to link or unlink accounts.
...
<table class="table table-fixed">
  ...
  <tbody>
    ...
    <tr>
      <td>You link user accounts with the <a href="/api/management/v2#!/Users/post_identities">Link a user account</a> endpoint of the Management API, you send an Access Token in the <code>Authorization</code> header, and the secondary account's <code>user_id</code> in the payload</td>
    ...
    <tr>
      <td>You link user accounts with the <a href="/auth0js#user-management">Auth0.js library</a>, and you use an Access Token to instantiate <code>auth0.Management</code></td>
      <td><div class="label label-default">No change</div></td>
      <td>N/A</td>
    </tr>
    <tr>
