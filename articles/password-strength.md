...
![Password Strength Panel in Auth0](@@env.MEDIA_URL@@/articles/password-strength/jH0kabJPoi.png)
...
![Auth0 Lock Password Strength checks on Desktop](@@env.MEDIA_URL@@/articles/password-strength/7cmjQFY45M.png)

On mobile:

![Auth0 Lock Password Strength checks on Mobile](@@env.MEDIA_URL@@/articles/password-strength/moUbn4XXxR.png)
