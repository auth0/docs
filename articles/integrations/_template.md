...
The first thing you need to do is go to the [Third party apps](https://@@uiURL@@/#/externalapps/create) section in the dashboard and choose <%= integration.name %> from the list of apps.
