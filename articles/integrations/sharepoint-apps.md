...
![](../@@env.MEDIA_URL@@/articles/integrations/sharepoint-apps/90SvG.png)
...
![](../@@env.MEDIA_URL@@/articles/integrations/sharepoint-apps/90SEc.png)
...
![](../@@env.MEDIA_URL@@/articles/integrations/sharepoint-apps/90SUB.png)
...
![](../@@env.MEDIA_URL@@/articles/integrations/sharepoint-apps/8XoVl.png)
...
![](../@@env.MEDIA_URL@@/articles/integrations/sharepoint-apps/8Xp6x.png) 
