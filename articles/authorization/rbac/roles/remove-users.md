...
description: Learn how to remove users assigned to a role using the Auth0 Dashboard. For use with Auth0's API Authorization Core feature set.
topics:
  - authorization
  - dashboard
  - permissions
...
This guide will show you how to remove the users assigned to a <dfn data-key="role">[role](/authorization/concepts/rbac)</dfn> using Auth0's Dashboard.
