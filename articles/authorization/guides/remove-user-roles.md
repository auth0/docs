...
This guide will show you how to remove the [roles](/authorization/concepts/rbac) assigned to a user using Auth0's Dashboard. The assigned roles are used with the API Authorization Core feature set.
