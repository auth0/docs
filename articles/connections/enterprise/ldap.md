---
title: Connect Your App using LDAP
connection: LDAP
image: /media/connections/ldap.png
public: true
seo_alias: ldap
description: Learn how to connect your app using Lightweight Directory Access Protocol (LDAP) through an enterprise connection.
topics:
    - connections
    - enterprise
    - ldap
...
To use your new LDAP connection, you must first [enable the connection](/dashboard/guides/connections/enable-connections-enterprise) for your Auth0 Applications.
