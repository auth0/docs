...
1. If you're using Windows Server 2019, the Edit Claim Issuance Policy dialog box automatically opens after you create the Relying Party Trust.
If you're using Windows Server 2012 or 2016, you need to open it manually:
