...
See [Custom Database Action Script Templates](/connections/database/custom-db/templates) and [Database action script  best practices](/docs/best-practices/custom-db-connections-scripts#database-action-script-best-practices) for details on all the scripts.
