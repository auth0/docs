...
To connect your Auth0 app to Dropbox, you will need to generate a *Client ID* and *Client Secret* in an Dropbox app, copy these keys into your Auth0 settings, and enable the connection.
