...
This article describes how to add login with Facebook to your app. It also discusses how you can get an <dfn data-key="access-token">Access Token</dfn> in order to access the Facebook API.
