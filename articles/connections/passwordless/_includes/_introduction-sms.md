With an SMS connection, the user is asked to enter a phone number, to which Auth0 sends a one-time-use code using [Twilio](http://www.twilio.com). The user then enters the code into your application.
