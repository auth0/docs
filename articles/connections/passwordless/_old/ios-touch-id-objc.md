...
::: warning
This feature is disabled for new tenants as of June 8th 2017. Any tenant created after that date won't have the necessary [legacy grant types](/applications/concepts/grant-types-legacy) to use Touch ID. This document is offered as reference for older implementations.
:::
