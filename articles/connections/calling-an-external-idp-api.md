...
In most cases, the user will only have one identity, but if you have used [account linking](/users/concepts/overview-user-account-linking), there may be more.
