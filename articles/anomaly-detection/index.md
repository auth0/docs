...
* An administrator removes the block via the Dashboard (by clicking `unblock` under the `ACTIONS` button when viewing the user's details) or by using the [Management API](https://auth0.com/docs/api/management/v2#!/User_Blocks/delete_user_blocks) ;
