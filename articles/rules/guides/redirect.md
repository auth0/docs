...
4. Once the password has successfully been changed, the application extracts the `authorize_again` claim from the verified and decoded JWT and redirects the user to that URL to have them sign in with their new password.
