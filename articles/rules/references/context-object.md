...
| `context.idToken` | An object representing the options defined on the [ID Token](/tokens/id-token). Used to add custom [namespaced](/tokens/concepts/claims-namespacing) claims to the ID Token. |
