...
```
The following parameters are appended to the `url` as query string to include the error information. Note that the parameters presented in the `url` varies depending on the error type.
* `client_id`
* `connection`
* `lang`
* `error`
