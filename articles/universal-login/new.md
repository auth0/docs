...
- If you have a rule that sets the MFA provider to `google-authenticator` you'll need to also enable the OTP factor in the Dashboard > MFA](${manage_url}/#/mfa) section.
