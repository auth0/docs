...
You can also specify the enabled languages for the tenant the Management API using [Update tenant settings endpoint](/api/management/v2#!/Tenants/patch_settings). The first language in the list will be the default one.
