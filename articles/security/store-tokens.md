...
For an overview of this approach and an example implementation check out: [Single-Page App Authentication Using Cookies](/login/spa/authenticate-with-cookies)
