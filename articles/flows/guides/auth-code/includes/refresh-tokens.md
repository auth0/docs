...
::: warning
You should validate your tokens before saving them. To learn how, see [Validate ID Tokens](/tokens/guides/validate-id-token) and [Validate Access Tokens](/tokens/guides/validate-access-tokens).
:::
