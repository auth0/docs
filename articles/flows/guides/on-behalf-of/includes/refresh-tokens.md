...
| `client_id`     | If you're using a Refresh Token for your Source API, your application's Client ID. You can find this in the **Client ID** field in your [Application's Settings tab](${manage_url}/#/applications/${account.clientId}/settings). If you're using a Refresh Token for your Target API, your Source API's Client ID. You can find it in the **Client ID** field under **Token Exchange Settings** in your [API's Settings tab](${manage_url}/#/apis/). |
