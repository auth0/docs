...
Once the user visits the `verification_uri` and inputs their `user_code`, you'll need to get the user's authorization. This step may include one or more of the following processes:
