...
* **Public versus confidential**: Applications can be classified as either confidential or public, according to the OAuth 2.0 spec (https://tools.ietf.org/html/rfc6749#section-2.1). The main difference relates to whether or not the application is able to hold credentials securely. For more info, see [Application Types: Public vs. Confidential](/applications/concepts/app-types-public-confidential).
