...
* **Auth0 application type**: To add authentication to your application, you must first register it with Auth0 and select an application type. Auth0 recognizes four application types: Regular Web Application, Single-Page Application, Native/Mobile Application, and Machine-to-Machine (M2M) Application. For more info, see [Auth0 Application Types](/applications/concepts/app-types-auth0).
