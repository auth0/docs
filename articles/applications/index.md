...
* Learn how to [remove an application using the Auth0 Dashboard](/dashboard/guides/applications/remove-application) or the [Management API](/applications/guides/remove-application-mgmt-api).
