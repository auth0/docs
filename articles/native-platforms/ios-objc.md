...
> You can also <a href="/native-mobile-samples/master/create-package?path=iOS/basic-sample&type=replace&filePath=iOS/profile-sample-swift/ProfileSample/Info.plist@@account.clientParam@@">download</a> our sample project that shows how to store/update your user profile with Auth0
