...
::: version-warning
User search v2 will be deprecated on **November 13rd 2018**. Also, new tenants starting **June 6th 2018** cannot use this version anymore. We recommend you use [user search v3](/users/search/v3).
:::
