...
This document will demonstrate how you can search for users and give some example queries. It is, however suggested that, you also reference the [Query String Syntax document](/api/management/v2/query-string-syntax) for more examples of the query string syntaxes.
