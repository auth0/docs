...
::: version-warning
User search v2 has reached its end of life as of **June 30th 2019**. For information on migrating from user search v2 to v3, see [Migrate from search engine v2 to v3](/users/search/v3/migrate-search-v2-v3).
:::
