...
The user search engine v2 will be deprecated on **November 13rd 2018**, so we recommend migrating user search functionality to search engine v3 (`search_engine=v3`). Before you start migrating, there's a few things you should know:
