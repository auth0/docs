...
- To access any Management APIv2 endpoint you need an Access Token (which you should set at the `{access-token}` placeholder of the `Authorization` header). For information on how to get one see [Access Tokens for the Management API](/api/management/v2/concepts/tokens).
