...
In order for an application to use Auth0 it must be registered as an [application](/applications/concepts/app-types-auth0). Create a new application on the [Dashboard](https://manage.auth0.com/#/applications).
