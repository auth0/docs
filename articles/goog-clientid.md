...
![](../media/articles/goog-api-app-empty.png)
...
![](../media/articles/goog-api-app-info.png)
...
![](../media/articles/goog-api-creation-activity.png)
...
![](../media/articles/goog-api-plus-off.png)

Enable it by clicking **OFF**.

![](../media/articles/goog-api-plus-on.png)
...
![](../media/articles/goog-api-product-name.png)
...
![](../media/articles/goog-api-credentials.png)
...
![](../media/articles/goog-api-client-creation.png)

Click **Create Client ID**. The resulting settings will be displayed:

![](../media/articles/goog-api-client-settings.png)
...
![](../media/articles/goog-api-admin-sdk.png)
