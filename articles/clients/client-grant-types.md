...
As of 31 May 2017, new Auth0 customers **cannot** add *any* of the legacy grant types to their Clients. Only customers as of 31 May 2017 can add legacy grant types to their existing Clients.
:::
...
To avoid changes in functionality for current Auth0 customers, we will populate the `grant_types` property for all existing Clients as of 31 May 2017 with **all** Auth0 legacy, Auth0 extension, and specification-conformant grant types.
...
::: warning
Only Auth0 customers as of 31 May 2017 may enable a legacy grant type for existing Clients.
:::
