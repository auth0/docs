...
::: note
You can find the __Global Client ID__ and __Global Client Secret__ information at the __Global Client information__ section of [your Domain Advanced Settings](${manage_url}/#/tenant/advanced).
:::
