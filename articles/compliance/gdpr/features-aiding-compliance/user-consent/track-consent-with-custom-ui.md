...
Before you call the Management API you need to get a valid token. For details on how to do that see [Get Access Tokens for Production](/api/management/v2/tokens/get-access-tokens-for-production).
