...
In this tutorial we will see how you can use Lock to ask for consent information, and then save this input at the user's [metadata](/users/concepts/overview-metadata).
...
All scenarios will save the following properties at the [user's metadata](/users/concepts/overview-metadata):
