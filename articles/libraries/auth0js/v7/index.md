...
This document covers an out-of-date version of auth0.js - version 7. If you are already using version 8, you can take a look at the [v8 reference](/libraries/auth0js), or if you are using v7 but interested in upgrading, take a look at the [v8 migration guide](/libraries/auth0js/migration-guide).
:::
