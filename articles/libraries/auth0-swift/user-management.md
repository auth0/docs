...
The Management API provides functionality that allows you to link and unlink separate user accounts from different providers, tying them to a single profile (See [Linking Accounts](/users/concepts/overview-account-linking) for details.) It also allows you to update user metadata.
