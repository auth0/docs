...
After you update to Lock v11 and/or Auth0.js v9, it is advised that you turn off the **Legacy Lock API** toggle in the Dashboard. This will make your Auth0 tenant behave as if the legacy API is no longer available. The `/usernamepassword/login` and `/ssodata` endpoints will be removed from service on **July 16, 2018**. These are used by Lock.js v8, v9, v10, and auth0.js v6, v7 and v8. After completing the migration to the latest versions make sure the Legacy Lock Migration toggle is turned off.
