...
You can customize the error messages that will be displayed on certain situations by providing a [dict option](/libraries/lock/customization#dict-object) at the [customization options](https://github.com/auth0/lock/wki/Auth0Lock-customization):
