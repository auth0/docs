...
<%= include('../../_includes/_package', { pkgRepo: 'native-mobile-samples', pkgBranch: 'master', pkgPath: 'iOS/custom-ui-sample-swif', pkgFilePath: 'iOS/custom-ui-sample-swift/Evilation/Info.plist', pkgType: 'replace' }) %>
