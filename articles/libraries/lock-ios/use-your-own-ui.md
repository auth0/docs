...
<div class="package" style="text-align: center;">
  <blockquote>
   <a href="/package/native-mobile-samples/master?path=iOS/custom-ui-sample-swift&type=replace&filePath=iOS/custom-ui-sample-swift/Evilation/Info.plist${account.clientParam}" class="btn btn-lg btn-success btn-package" style="text-transform: uppercase; color: white">
