...
For a full list of the names used in the default `strings.xml` file, see the [Lock.Android repo](https://github.com/auth0/Lock.Android/blob/master/lib/src/main/res/values/strings.xml).
