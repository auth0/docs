...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-ad-mt-single-tenant-example.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-ad-multi-tenant-example.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-new-a0-app.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-create-directory.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-domain-name.png)

This domain will also require verification and you'll need to add a TXT/MX record as described in the verification page.

![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-domain-verified.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-new-app.png)

![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-new-app-name.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-new-app-prop.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-app-config.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azuread-mt-app-perm.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-new-conn.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-conn-comm-endpoint.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-app-homepage.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-consent-page.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-login-popup.png)
...
![](../@@env.MEDIA_URL@@/articles/scenarios/multi-tenant-saas-azure-ad/azure-mt-profile.png)
