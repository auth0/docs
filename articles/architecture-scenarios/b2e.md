...
Monitoring the infrastructure and services that your applications depend on is critical. [Auth0 provides monitoring endpoints](/monitoring/guides/monitoring-auth0) as well as a status page you can subscribe to.
