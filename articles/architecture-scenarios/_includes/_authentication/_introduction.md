...
If you have an existing legacy identity store, you’ll also want to see <% if (scenario === "b2c") { %>[User Migration](./b2c-provisioning#user-migration)<% } else { %><% } %>. This section discusses the advantages of migrating to Auth0’s managed identity storage in terms of safety and security.
