...
<% if (platform === "b2b") { %>
If you are sharing an Auth0 tenant across multiple customer organizations, providing organizations with their own domain of users, and managing their credentials, you will need to consider how the users will know which credentials they should use and trust that this is where they should enter them. See [Branding login by organization](#branding-login-by-organization) for details. 
<%  } %>
