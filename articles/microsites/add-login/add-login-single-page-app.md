---
title: Add Login to Single-Page App
...
::: whats-next
  ...
  * Many single-page apps access APIs to retrieve data, which can also be done using Auth0. Learn how to call your API from your app: [Call API from Single-Page App](/microsites/call-api/call-api-single-page-app).
