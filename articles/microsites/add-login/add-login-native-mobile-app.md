...
<img src="/media/articles/microsites/add-login/overview-flow-add-login-native-mobile-app.png" alt="Flow Overview for Native/Mobile Apps" width="100%">
...
::: whats-next
  ...
  * Most native/mobile apps access APIs to retrieve data, which can also be done using Auth0. Learn how to call your API from your native/mobile app in our tutorial: [Call My API from My Native/Mobile App](/microsites/call-my-api/call-my-api-native-mobile-app).
