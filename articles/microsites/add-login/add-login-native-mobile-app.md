...
::: whats-next
  ...
  * Most native/mobile apps access APIs to retrieve data, which can also be done using Auth0. Learn how to call your API from your app: [Call My API from My Native/Mobile App](/microsites/call-api/call-api-native-mobile-app).
