...
::: whats-next
  ...
  * Most regular web apps access APIs to retrieve data, which can also be done using Auth0. Learn how to call your API from your app: [Call My API from My Regular Web App](/microsites/call-api/call-api-regular-web-app).
