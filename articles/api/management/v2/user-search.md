...
Search for users without verified email | `email_verified:false OR NOT _exists:email_verified`
...
Search for all users that have never logged in | `(NOT _exists:logins_count OR logins_count:0)` 
