...
::: warning
New domains, starting September 1st 2017, cannot search any of the `app_metadata` fields. Paid domains (i.e. domains that have a credit card associated in the [Dashboard](${manage_url}/#/tenant/billing/payment)), that were created up to August 31st 2017, can search using the `app_metadata` fields.
:::
