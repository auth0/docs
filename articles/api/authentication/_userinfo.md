...
- To use this endpoint to return `user_metadata` or other custom information, add a custom ID token claim to an [Action](/secure/tokens/json-web-tokens/create-custom-claims#create-custom-claims). For more information refer to [User profile claims and scope](/api-auth/tutorials/adoption/scope-custom-claims).
