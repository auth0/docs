...
code generated by a propertly setup app and continue the flow on [mfa-otp](#link to api) grant type.
...
must use it to periodically check for the resolution of the transaction. Continue the flow on [mfa-oob](#link to api) grant type.
...
a different factor, you can skip this step an go directly to [Verifying OTP challenge and getting the tokens step](#link to api)
