...
This endpoint will deprecated in the future. Customers will be given ample time to migrate once an official deprecation notice is posted. The [GET /userinfo](#get-user-info) endpoint should be used instead to retrieve user information.
:::
