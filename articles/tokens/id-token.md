...
| sub | The unique identifier of the user. This is guaranteed to be unique per user and will be in the format <code>(identity provider)&#124;(unique id in the provider)</code>, e.g. <code>github&#124;1234567890</code>. |
