...
First, you have to generate an Access Token to call the Management API. For information on how to do that, see [Access Tokens for the Management API](/api/management/v2/tokens).
