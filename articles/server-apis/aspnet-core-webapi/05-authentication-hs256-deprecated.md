...
To learn how to allow only users in a certain role to access a particular endpoint, please continue with the [Authorization](https://auth0.com/docs/quickstart/backend/aspnet-core-webapi/06-authorization-deprecated) tutorial.
