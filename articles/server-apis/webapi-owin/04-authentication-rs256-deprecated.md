...
> If you want to use HS256 then please go to the [Authentication using HS256](https://auth0.com/docs/quickstart/backend/webapi-owin/05-authentication-hs256-deprecated) tutorial.
