...
![](../../media/articles/server-apis/wams-tutorial-4.png)
...
![](../../media/articles/server-apis/wams-tutorial-5.png)
...
![](../../media/articles/server-apis/wams-tutorial-6.png)

And then when querying, it filters out rows for the logged in user:

![](../../media/articles/server-apis/wams-tutorial-7.png)
