...
For this example, you'll create an [Express](https://expressjs.com/) server that acts as the backend API. This API will expose an endpoint to validate incoming [JSON Web Tokens](https://auth0.com/docs/jwt) before returning a response.
