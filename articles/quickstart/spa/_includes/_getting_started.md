...
::: note
**New to Auth?** Learn <a href="/overview" target="_blank" rel="noreferrer">How Auth0 works</a>, how it <a href="/architecture-scenarios/application/spa-api" target="_blank" rel="noreferrer">integrates with Single-Page Applications</a> and which <a href="/flows/concepts/auth-code-pkce" target="_blank" rel="noreferrer">protocol</a> it uses.
:::
