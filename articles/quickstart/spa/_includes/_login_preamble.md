...
* `access_token`: to learn more, see the [Access Token documentation](/tokens/concepts/access-tokens)
* `id_token`: to learn more, see the [ID Token documentation](/tokens/concepts/id-tokens)
