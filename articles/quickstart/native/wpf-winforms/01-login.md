...
The `Auth0.OidcClient.WPF` or `Auth0.OidcClient.WinForms` NuGet packages helps you authenticate users with any <a href="/identityproviders" target="_blank">Auth0 supported identity provider</a>.
...
This will load the Auth0 login page into a web view. You can learn how to customize the login page in <a href="/universal-login#simple-customization" target="_blank">this document</a>.
