...
The Auth0 package runs custom native code that needs to be configured at build time. You can use [Expo Config Plugin](https://docs.expo.dev/guides/config-plugins/) to achieve this.
