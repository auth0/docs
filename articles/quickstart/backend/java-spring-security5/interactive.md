...
Review <a href="get-started/auth0-overview/set-up-apis" target="_blank">our getting started guide</a> to set up your first API through the Auth0 dashboard.
...
* Use the <a href="/quickstart/backend/java-spring-security5/03-troubleshooting" target="_blank">Troubleshooting</a> section to check your configuration.
