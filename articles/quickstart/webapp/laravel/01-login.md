...
You can update user information using the <a href="https://github.com/auth0/laravel-auth0/blob/main/Management.md" target="_blank">Auth0 Management API</a>. All Management endpoints are accessible through the SDK's `management()` method.
...
- <a href="http://localhost:8000" target="_blank">http://localhost:8000</a> to see the pubic route, now authenticated.
