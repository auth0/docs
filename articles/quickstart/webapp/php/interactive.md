...
The Auth0 PHP SDK requires <a href="https://www.php-fig.org/psr/psr-17/" target="_blank">PSR-17</a> and <a href="https://www.php-fig.org/psr/psr-18/" target="_blank">PSR-18</a> compatible HTTP libraries to be installed for managing network requests. If you don't have libraries available, you can install reliable choices by running the following commands in your terminal:
