...
For the purposes of this example, we'll be using the <a href="https://authlib.org/" target="_blank" rel="noreferrer">Authlib</a> OAuth library and <a href="https://flask.palletsprojects.com/en/2.0.x/" target="_blank" rel="noreferrer">Flask</a>.
