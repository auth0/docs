...
This quickstart guide uses `https://schemas.quickstarts.com` for the claim [namespace](/tokens/concepts/claims-namespacing). We recommend that you use a namespace related to your own Auth0 tenant for your claims, for example, `https://schemas.YOUR_TENANT_NAME.com`.
