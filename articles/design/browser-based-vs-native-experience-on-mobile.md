...
Using a browser-based flow protects you from this, since the callback URL is linked to the app through [universal app links](https://developer.apple.com/ios/universal-links/) (iOS) or [App Links](/applications/guides/enable-android-app-links-dashboard) (Android). Note, however, that this is **not** a universally supported feature.
