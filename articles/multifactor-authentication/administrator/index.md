...
Some words about Guardian

## Enabling Guardian for your users
* Turning it on
...
* Guardian for select users
* Guardian for select apps

* Pre-enrollment
** Turning off on-the-fly enrollment
* Reset MFA (Guardian?) for a user

## Customization
* Customize Guardian 'screen'
