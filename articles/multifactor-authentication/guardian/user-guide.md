...
### Enrolling for MFA
Enrolling for MFA is a separate step, distinct from the initial sign-up for Auth0. Typically, the user is prompted to enroll the first time they attempt to sign-in to a client protected by MFA.
