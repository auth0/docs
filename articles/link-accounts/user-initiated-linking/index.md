...
If you don't use Lock at all, but call the Authentication API directly, follow our tutorial on [calling an API using the Single-Page Login Flow](/flows/guides/single-page-login-flow/call-api-using-single-page-login-flow) tutorial.
