...
If you don't use Lock at all, but call the Authentication API directly, follow our tutorial, [Call API Using the Implicit Flow](/flows/guides/auth-code-pkce/call-api-auth-code-pkce) tutorial.
