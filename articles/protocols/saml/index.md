...
Auth0 implements proven, common and popular identity protocols used in consumer oriented web products (like OAuth 2.0 and OpenId Connect) and in enterprise deployments (like [SAML](/saml-configuration), WS-Federation and LDAP).
