...
This guide explains to enroll and challenge users using Push Notifications with the Guardian Application or SDK. First, make sure that Push is [enabled as factor](/mfa/guides/configure-push) in the Dashboard or using the [Management API](/api/management/v2#!/Guardian/put_factors_by_name).
