...
::: note
Private Cloud supports Twilio and Custom SMS via Phone Message Hook only. Sending via Auth0 default delivery for testing purposes is not supported for Private Cloud deployments.
:::
