...
In other words, you need to select a uri (for example `/auth0/callback`) and configure it in your [Auth0 admin page](https://@@uiURL@@/#/applications/) and also, add it as a route in Laravel
