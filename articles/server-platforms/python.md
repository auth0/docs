...
You can add the following annotation to your `Flask` app to check if the user is authenticated. Note that for this to work, you must import `wraps` first, adding the following to your file `from functools import wraps`.
