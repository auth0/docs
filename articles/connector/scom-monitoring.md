...
![ss-2014-12-11T22-48-51.png](../@@env.MEDIA_URL@@/articles/connector/scom-monitoring/ss-2014-12-11T22-48-51.png)

* Enter a name and description:

![ss-2014-12-11T22-49-57.png](../@@env.MEDIA_URL@@/articles/connector/scom-monitoring/ss-2014-12-11T22-49-57.png)

* Select the Server in which the AD/LDAP Connector is installed and then choose "Auth0 ADLDAP":

![ss-2014-12-11T22-50-37.png](../@@env.MEDIA_URL@@/articles/connector/scom-monitoring/ss-2014-12-11T22-50-37.png)
