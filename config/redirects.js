...
const redirects = [
  ...
  },
  {
    from: [
      "/custom-signup",
      "/libraries/lock/v10/custom-signup",
      "/libraries/lock/v11/custom-signup",
    ],
  ...
  {
    from: [
      "/libraries/lock/v11/ui-customization",
      "/libraries/lock/v9/ui-customization",
    ],
  ...
  {
    from: [
      "/libraries/lock-ios/logging",
      "/libraries/lock-ios/v2/logging",
      "/libraries/lock-ios/v1/logging",
    ],
  ...
  {
    from: [
      "/tutorials/local-testing-and-development",
  ...
  {
    from: [
      "/libraries/lock-android/custom-fields",
      "/libraries/lock-android/v2/custom-fields",
    ],
  ...
  {
    from: [
      "/libraries/lock-android/v2/configuration",
      "/libraries/lock-android/v1/configuration",
    ],
  ...
  {
    from: [
      "/libraries/lock-android/v2/passwordless-magic-link",
      "/libraries/lock-android/v1/passwordless-magic-link",
    ],
