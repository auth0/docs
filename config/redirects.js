  ...
  { from: '/rules/current/management-api', to: '/rules/guides/management-api' },
  {
   ...
   },
   {
    ...
    },
    {
        ...
        to:   '/configure/applications/enable-universal-links',
    },
    {
        from: '/dashboard/guides/applications/enable-android-app-links',
        to:   '/configure/applications/enable-android-app-links',
    },
    {
        from: '/dashboard/guides/applications/enable-sso-app',
        to:   '/configure/applications/enable-sso',
    },
    {
        from: '/dashboard/guides/applications/remove-app',
        to:   '/configure/applications/remove-app',
    },
    {
        from: '/dashboard/guides/applications/set-up-addons',
        to:   '/configure/applications/set-up-addons',
    },
    {
    ...
    },
    {
        ...
        to:   '/configure/applications/view-addons',
    },
    {
        from: '/dashboard/guides/applications/view-app-type-confidential-public',
        to:   '/configure/applications/view-app-type-confidential-public',
    },
    {
        from: '/best-practices/application-settings',
        to:   '/configure/applications/recommended-settings',
    },
    {
        from: '/guides/ip-whitelist',
        to:   '/configure/ip-whitelist',
    },
    {
        from: '/dashboard/reference/settings-api',
        to:   '/configure/apis/settings',
    },
    {
    ...
    },
    {
        ...
        to:   '/configure/sso/sso-auth0',
    },
    {
        from: '/sso/legacy',
        to:   '/configure/sso/legacy',
    },
    {
        from: '/sso/legacy/regular-web-apps-sso',
        to:   '/configure/sso/legacy/regular-web-apps-sso',
    },
    {
        from: '/sso/legacy/single-page-apps',
        to:   '/configure/sso/legacy/single-page-apps',
    },
    {
        from: '/protocols/saml/saml-apps/cisco-webex',
        to:   '/configure/saml/sso-integrations/cisco-webex',
    },
    {
        from: '/protocols/saml/saml-apps/datadog',
        to:   '/configure/saml/sso-integrations/datadog',
    },
    {
        from: '/protocols/saml/saml-apps/egencia',
        to:   '/configure/saml/sso-integrations/egencia',
    },
    {
        from: '/protocols/saml/saml-apps/eloqua',
        to:   '/configure/saml/sso-integrations/eloqua',
    },
    {
        from: '/protocols/saml/saml-apps/freshdesk',
        to:   '/configure/saml/sso-integrations/freshdesk',
    },
    {
        from: '/protocols/saml/saml-apps/github-cloud',
        to:   '/configure/saml/sso-integrations/github-cloud',
    },
    {
        from: '/protocols/saml/saml-apps/github-server',
        to:   '/configure/saml/sso-integrations/github-server',
    },
    {
        from: '/protocols/saml/saml-apps/google-apps',
        to:   '/configure/saml/sso-integrations/google-apps',
    },
    {
        from: '/protocols/saml/saml-apps/heroku',
        to:   '/configure/saml/sso-integrations/heroku',
    },
    {
        from: '/protocols/saml/saml-apps/hosted-graphite',
        to:   '/configure/saml/sso-integrations/hosted-graphite',
    },
    {
        from: '/protocols/saml/saml-apps',
        to:   '/configure/saml/sso-integrations/',
    },
    {
        from: '/protocols/saml/saml-apps/litmos',
        to:   '/configure/saml/sso-integrations/litmos',
    },
    {
        from: '/protocols/saml/saml-apps/pluralsight',
        to:   '/configure/saml/sso-integrations/pluralsight',
    },
    {
        from: '/protocols/saml/saml-apps/sprout-video',
        to:   '/configure/saml/sso-integrations/sprout-video',
    },
    {
        from: '/protocols/saml/saml-apps/tableau-online',
        to:   '/configure/saml/sso-integrations/tableau-online',
    },
    {
        from: '/protocols/saml/saml-apps/tableau-server',
        to:   '/configure/saml/sso-integrations/tableau-server',
    },
    {
        from: '/protocols/saml/saml-apps/workday',
        to:   '/configure/saml/sso-integrations/workday',
    },
    {
        from: '/protocols/saml/saml-apps/workpath',
        to:   '/configure/saml/sso-integrations/workpath',
    },
    {
    ...
    },
    {
        ...
        to:   '/configure/saml/saml-idp-eloqua',
    },
    {
        from: '/protocols/saml/saml-idp-generic',
        to:   '/configure/saml/saml-idp-generic',
    },
    {
        from: '/protocols/saml/saml-sp-generic',
        to:   '/configure/saml/saml-sp-generic',
    },
    {
        from: '/protocols/saml/saml2webapp-tutorial',
        to:   '/configure/saml/saml2webapp-tutorial',
    },
    {
        from: '/protocols/saml/samlp-providers',
        to:   '/configure/saml/samlp-providers',
    },
    {
        from: '/protocols/saml/samlp',
        to:   '/configure/saml/samlp',
    },
    {
        from: '/protocols/saml/samlsso-auth0-to-auth0',
        to:   '/configure/saml/samlsso-auth0-to-auth0',
    },
    {
    ...
    },
    {
        ...
        to:   '/configure/anomaly-detection/breached-passwords',
    },
    {
        from: '/anomaly-detection/guides/customize-blocked-account-emails',
        to:   '/configure/anomaly-detection/customize-blocked-account-emails',
    },
    {
        from: '/anomaly-detection/guides/enable-disable-brute-force-protection',
        to:   '/configure/anomaly-detection/enable-disable-brute-force-protection',
    },
    {
    ...
    },
    {
        ...
        to:   '/configure/anomaly-detection/faqs',
    },
    {
        from: '/anomaly-detection/references/anomaly-detection-restrictions-limitations',
        to:   '/configure/anomaly-detection/restrictions-limitations',
    },
    {
        from: '/anomaly-detection/references/breached-password-detection-triggers-actions',
        to:   '/configure/anomaly-detection/breached-password-detection-triggers-actions',
    },
    {
    ...
    // 
    {
        ...
        to:   '/about-auth0/overview'
    },
    {
        from: '/getting-started/the-basics',
        to:   '/about-auth0/the-basics'
    },
