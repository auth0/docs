...
<% } else { %>
<p>Please remember that for security purposes, you have to register the callback URL of your app on the <a href="https://@@uiURL@@/#/applications" target="_blank">Application Settings</a> section on Auth0 Admin app.</p>
<% } %>
