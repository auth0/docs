...
Auth0 can help radically simplify the authentication process for Office 365. In this tutorial, you'll learn how to add Single Sign On (SSO) to Office 365 using Auth0. Your users will be able to log in using their existing Active Directory credentials, with support for Integrated Windows Authentication (Kerberos) and SSO with other third party applications they might be using like Salesforce, Dropbox, ...
...
![Office 365 Users](//cdn.auth0.com/docs/img/office-365-users-overview.png)
...
![Office 365 High-level Overview](//cdn.auth0.com/docs/img/office-365-high-level-overview.png)
...
![Office 365 Domain](//cdn.auth0.com/docs/img/office-365-domain.png)
...
![AAD Sync](//cdn.auth0.com/docs/img/office-365-aad-sync.png)
...
![Third Party App](//cdn.auth0.com/docs/img/office-365-third-party-app.png)
...
![Settings Page](//cdn.auth0.com/docs/img/office-365-settings-page.png)
...
![Login with Kerberos](//cdn.auth0.com/docs/img/office-365-login-kerberos.gif)
...
![Login Page](//cdn.auth0.com/docs/img/office-365-login-page.png)
...
![IdP Login External](//cdn.auth0.com/docs/img/office-365-idp-login-external.gif)

Users on a domain-joined machine will immediately be signed in to Office 365:

![IdP Login Kerberos](//cdn.auth0.com/docs/img/office-365-idp-login-kerberos.gif)
