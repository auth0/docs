...
<div class="package" style="text-align: center;">
  <blockquote>
    <a href="@@base_url@@/laravel-auth0/master/create-package?path=examples/laravel-api&filePath=config/laravel-auth0.php&type=server@@account.clientParam@@" class="btn btn-lg btn-success btn-package" style="text-transform: uppercase; color: white">
